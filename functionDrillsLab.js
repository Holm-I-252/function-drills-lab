...
function faveColorFinder(color) {
  if (color === "red") {
    ...
    return "green is a solid favoite color"
  } else if (color === "black") {
    return "so trendy"
  } else {
...
function bigOrSmall(arr) {
  ...
  return arrayEvalulator = answers
}
...
function frogTime(gold) {
  return gold / 3
}

totalFrogs = frogTime(90)
...
function frogTime2(gold) {
  return Math.floor(gold / 3)
}

totalFrogs2 = frogTime2(40)
